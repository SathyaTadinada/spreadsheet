...
public class SpreadsheetGrid : ScrollView, IDrawable, ISpreadsheetGrid {
    ...
    private Color headerColor = Colors.LightGray;
    ...
    public SpreadsheetGrid() {
        ...
        graphicsView.BackgroundColor = headerColor;
    ...
    /// <summary>
    /// Redraws the canvas with the new header and header text colors
    /// </summary>
    /// <param name="headerColor"></param>
    /// <param name="headerTextColor"></param>
    public void RedrawCanvas(int headerColor, int headerTextColor) {
        BackgroundColor = colors[headerColor];
        _canvas.FontColor = colors[headerTextColor];
